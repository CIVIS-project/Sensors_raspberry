...
//This section added for CIVIS project, managing RedisDB
    ...
    printf("Current timezone: %s",timezone);
	...
	sprintf(message,"%s\t%d-%02d-%02dT%02d:%02d:%02d%s\t%s\t%.1f\t%s", ApartmentID, tm.tm_year+1900, tm.tm_mon+1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec, timezone, SensorNumber, Value, "1");
	printf(message);
        printf("\n");
